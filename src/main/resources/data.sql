...
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('ebb5ad46-a012-46a1-8c60-f6723f0e515b', '2021-02-20 01:26:17.857762',
       'Reminder', 'A little reminder', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('4ffcd7b6-190a-4631-ad52-c7d63cd1b789', '2021-02-20 01:26:17.857762',
        'Information', 'Some bit of information', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('16825535-2ef7-4bda-a827-400570316cc4', '2021-02-20 01:26:17.857762',
        'Note', 'A small note', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('0c2751b2-e892-47ba-a65e-5468382075c7', '2021-02-20 01:26:17.857762',
        'Example', 'An example', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('cf8a1901-cb95-430c-83fc-c564e3ca7511', '2021-02-20 01:26:17.857762',
        'Github Repo', 'An external repo', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('542e443f-95f5-4734-b6e5-74497c9c6026', '2021-02-20 01:26:17.857762',
        'Tool', 'Some useful tool', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('5d00a2ef-7382-43a6-ac73-626f80b4902b', '2021-02-20 01:26:17.857762',
        'Tutorial', 'Some tutorial', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO INTENTS (ID, CREATION_TIME, INTENT, DESCRIPTION, CREATOR_ID)
values ('5ed6c8ca-ffc2-482d-b8e2-82cee910067f', '2021-02-22 01:26:17.857762',
        'Documentation', 'Some official documentation', '43471800-10cd-41ce-9c1e-26fe60814e26');

/* Some default tags */
INSERT INTO TAGS (ID, CREATION_TIME, TAG, CREATOR_ID)
values ('a1586bc2-31f4-4687-89ad-f2b74855af8a', '2021-02-20 01:26:17.857762',
        'Vaadin Fusion', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO TAGS (ID, CREATION_TIME, TAG, CREATOR_ID)
values ('fb38878c-7679-4d4a-b445-93b8754de1ab', '2021-02-20 01:26:17.857762',
        'LitElement', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO TAGS (ID, CREATION_TIME, TAG, CREATOR_ID)
values ('99857555-7338-438d-a905-0908675237ad', '2021-02-21 01:26:17.857762',
        'Hot peppers', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO TAGS (ID, CREATION_TIME, TAG, CREATOR_ID)
values ('324d0cf2-7c3c-4df1-aedd-37bf79ac14a1', '2021-02-21 01:26:17.857762',
        'Weightlifting', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO TAGS (ID, CREATION_TIME, TAG, CREATOR_ID)
values ('b3ab9836-e3ed-4f1b-a624-49cfa8c01e9c', '2021-02-21 01:26:17.857762',
        'Iaido', '43471800-10cd-41ce-9c1e-26fe60814e26');

/* Some default projects */
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID)
values ('2e0643dd-9150-4510-9a92-e3288a96561c', '2021-02-20 01:26:17.857762',
        'Software', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID, PARENT_PROJECT_ID)
values ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '2021-02-20 01:26:17.857762',
        'Vaadin Fusion', '43471800-10cd-41ce-9c1e-26fe60814e26', '2e0643dd-9150-4510-9a92-e3288a96561c');
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID, PARENT_PROJECT_ID)
values ('88ca0af3-a475-4cc8-a6bc-d869ee7f7f04', '2021-02-20 01:26:17.857762',
        'LitElement', '43471800-10cd-41ce-9c1e-26fe60814e26', '2e0643dd-9150-4510-9a92-e3288a96561c');
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID, PARENT_PROJECT_ID)
values ('d4c7c965-77ad-41a6-ab95-85e72f17a5ae', '2021-02-20 01:26:17.857762',
        'HTML', '43471800-10cd-41ce-9c1e-26fe60814e26', '2e0643dd-9150-4510-9a92-e3288a96561c');

INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID)
values ('9df1f06a-5468-40ab-abd9-d5b720a7639a', '2021-02-20 01:26:17.857762',
        'Hobbies', '43471800-10cd-41ce-9c1e-26fe60814e26');
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID, PARENT_PROJECT_ID)
values ('d5c2bb9e-b2cd-4f33-a25b-f0b997fe524d', '2021-02-20 01:26:17.857762',
        'Cool stuff', '43471800-10cd-41ce-9c1e-26fe60814e26', '9df1f06a-5468-40ab-abd9-d5b720a7639a');
INSERT INTO PROJECTS (ID, CREATION_TIME, PROJECT, CREATOR_ID, PARENT_PROJECT_ID)
values ('fafe3a1c-6a06-42de-8174-bec06a7e1227', '2021-02-20 01:26:17.857762',
        'Sports', '43471800-10cd-41ce-9c1e-26fe60814e26', '9df1f06a-5468-40ab-abd9-d5b720a7639a');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '00fe386e-83bc-4627-84b0-b46814fd1911');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '5cf09f3a-ffc5-4917-9af1-e48e6903a43e');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '23fd6687-81d3-4c7d-9df7-8e5480d5ee93');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('88ca0af3-a475-4cc8-a6bc-d869ee7f7f04', '83a16308-8e3c-4da9-ab35-c0f6a07883c2');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '70d15841-c27e-4264-a892-b3681f158abd');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('d4c7c965-77ad-41a6-ab95-85e72f17a5ae', 'dd16120d-0d44-4060-8659-4314c120f35f');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '328e1649-602a-4bf3-9613-52c50e5e6327');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('f2488961-90ba-4618-a8cb-f8aef5d1ae68', '288c3f3b-3f12-4fbe-8a44-10624fdc5359');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('88ca0af3-a475-4cc8-a6bc-d869ee7f7f04', '76c4cc8b-7101-4af4-b7d9-9512e7f949b8');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('88ca0af3-a475-4cc8-a6bc-d869ee7f7f04', '3774f5b1-d9f2-4db8-b5dd-311ce66785b3');
...
INSERT INTO SNIPPET_PROJECTS (PROJECT_ID, SNIPPET_ID) VALUES ('88ca0af3-a475-4cc8-a6bc-d869ee7f7f04', 'c1ebe0d3-a876-4dbf-b439-ee659fa093eb');
